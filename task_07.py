...
for code in titles.items():
    # print(code)

    intermediate_quantity = 0
    intermediate_cost = 0
    total_cost = 0
    total_quantity = 0

    for stock_balance in sales[code[1]]:
        # print(stock_balance)
        intermediate_quantity = intermediate_quantity + stock_balance['quantity']
        intermediate_cost = stock_balance['quantity'] * stock_balance['price']
        total_quantity = intermediate_quantity
